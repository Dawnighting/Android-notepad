...
public class StickyActivity extends BaseActivity {
        ...
        findViewById(R.id.save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(titleStr)) {
                    ...
                    if (mContentDao == null) {
                        mContentDao = new ContentDao(StickyActivity.this);
                    }
                    int row = mContentDao.add(titleStr, timeStr, detailStr, 3);
                    if (row > 0) {
                        showToast("保存成功");
                        setResult(200);
                        finish();
    ...
    public void initCustomTimePicker() {
        ...
        pvCustomTime = new TimePickerBuilder(StickyActivity.this, new OnTimeSelectListener() {
            @Override
